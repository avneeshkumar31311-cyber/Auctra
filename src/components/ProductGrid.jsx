export default function ProductGrid() {
  const products = [
    { lot: "881", title: "Chronos V Obsidian", price: "$142,000", tag: "Live", isPulse: true, img: "https://lh3.googleusercontent.com/aida-public/AB6AXuCUPeAPLCJNMoeh0kmJxi4J6d3EyF6bdRjtHdoeNCT365iTifGpVBor4qgHmzI1aLVLPZjdMc8PLeZtN2rO0mBbNHkkKUX1FnxIQIGo3CzCT6iG6DhR2v1lPQmEW2AFk2i4MRqUNUCH8dI-bnlY6USWOVkXU9bbMS-Z5oHpbU_O6QpVuOZu7yRMFiZYENaNmv1O-8pz2MG1C2JJYT-vpedX6se75WYoWPzGUnC5BZcmwdxUz07PyrdIgm60WR1reeLIU-D1eJ9P7wY" },
    { lot: "742", title: "1969 Spectre Coupe", price: "$890,000", tag: "Live", isPulse: true, img: "https://lh3.googleusercontent.com/aida-public/AB6AXuAkbNH6Gg02iDZ42015qkZ-PxoumCqiqiTBMi70iAYShu0LrhbwTlr6np2e4RnzcgEmPWPtfVhcAn9NudFWrpqmvwuJaqUoFPQEF5RQAQdjyqQWWkOHE_zbG-mT2IdjSGyDXWoBwQBmeE2T3geO9iq4OxtitLdAetQXua58hFdYPkq4SeqrRl0QHP2O3J7EOo0HXVMsHgSQQK3cQL6vE6IskAY8ifHHWYgQMXVxqVPxdekDlJc3MLJbl7Y948iPsIVdP8t8MECwby8" },
    ...
    { lot: "303", title: "Gilded Void No. 4", price: "$210,000", tag: "Live", isPulse: true, img: "https://lh3.googleusercontent.com/aida-public/AB6AXuBorQIQJCD_hotwP0wh9qW0LqSwC3I-Cz3EgLZ9rirQts76HMfO-igOw_O_ZjOjnKCCWxgJzsKLwIMPKh-2krBC1ndGjbpqA17y8JZXHFE875dgZp_IT6BxUexQiu-6KU9rAAFMHw993DQsi4y6LSC95FuQbcGAMhyrCHT2dvf97rht0vpMrwfy32_bGQAtbRa8RqvQn2Aw9QTY-4ltwDI29Svv2sJIJNebmMWoUMxbP3K3mzYpktN8uiT9bmpTMpfA5ciS2dpTA5E" },
    ...
    { lot: "003", title: "Attic Gold Stater", price: "$125,000", tag: "Pre-Bid", isPulse: false, img: "https://lh3.googleusercontent.com/aida-public/AB6AXuAhxKwJrys7J5RQ9behhXU2JGM8fJ6ctbJtyBRBWIs60frNRj_vCPTiCsEck2a2LAeQTwwIbqg1tmSLfvrNLVY7ZV2ORhoYVq3sfUf14x83uawLY8BkVui7qk4tunetu0xVR084TfmRzk_z7oQwnf7JyZw8JdTPNyG4wVoRwm-Htj9QG2LuZ50Fsp-yAXU1a1hFrO4AZYJaTA7BaTfxy-fF5KUxfD8P36uHNFq26nSPU0Mm73i5FUAZteeYMbGsDdrtF_UCA4ALcm8" },
    { lot: "772", title: "Stradivarius Variant", price: "$3,400,000", tag: "Live", isPulse: true, img: "https://lh3.googleusercontent.com/aida-public/AB6AXuB9Azv98rB1WajWA1Z279cvVTxkH7Z8cQ2vfvy0vvEZ8Fk4yC_WKyu2Usc88_R9UGiUOLd6WHWEU6ZZlue9oLyRkLkb1KyGGwXV-t9ulxY0ytmj_3CyYTndixeZdqJDydS9H4OmzQZBwW7i2iXTdZBa9DkIMVmvhKtTBM7Hp8bfw22uXWqfD3OYPht0KahkNrUo9JoKtszXfDUBVDjsZB0vukxqnjZkHNVGOIFgfujqnmn8LzkXiHCN9XQ-4GNilFsBZ_4RU66b61o" },
    { lot: "104", title: "Birkin Himalayan", price: "$280,000", tag: "Live", isPulse: true, img: "https://lh3.googleusercontent.com/aida-public/AB6AXuC1ylKSzqK80yNT0n_nTwEhJ0UUqORab1ccXrRj7jajTUMtbrgPB40szm_s9wdEctl3wq2AplqwdJRACIpMfWDtkKDYAxJ_VOs7emhjjzYPiWqw015l8bjxsbC3Kj0QZNzpz5obphv026LSsXsiQcP6Bl2vqKr9Xb33lAVuCE-y10WbwzkoDYOAsZq6OztAX1-FsmbXCpGxSgyUqGXTC9_C2jr7JPuoC05Uk6txoLajZZ7UyTisBLpcrEE55QAp4_YgPbrlNc5ZGz8" }
  ];
    ...
    <section className="py-32 px-12 bg-surface-container-lowest">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-12">
        {products.map((item, idx) => (
          <div key={idx} className="group bg-surface-container-low transition-all duration-500 hover:-translate-y-2">
            <div className="aspect-[4/5] relative overflow-hidden">
              ...
              {item.isPulse ? (
                <div className="absolute top-4 right-4 bg-error px-3 py-1 flex items-center gap-2">
            ...
            <div className="p-8">
              ...
              <div className="flex justify-between items-center">
                <p className="font-label text-primary text-lg">{item.price} USD</p>
                <span className="material-symbols-outlined text-stone-600 hover:text-primary cursor-pointer transition-colors">favorite</span>
              </div>
            </div>
          </div>
        ))}
